...
VALUES(DEFAULT, 1, 1, "diosa!!!!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 1, 2, "Que linda!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 1, 3, "Alta playa amigaaa!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 1, 4, "Bombaaa!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 2, 5, "Te quiero mucho amigaaa", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 2, 1, "las quierooo", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 2, 2, "diosasss", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 2, 3, "bombonas", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 3, 4, "Ehhh alta crack", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 3, 5, "Que linda la vista!!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 3, 1, "bueena fachaaaaa", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 3, 2, "crack", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 4, 3, "Boquita wachoooo", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 4, 4, "Como amo a boca", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 4, 5, "VAMOS BOCAAAAAAAAAAA", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 4, 1, "VAMOS RIVER!!!!!!!!!!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 5, 2, "Divino", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 5, 3, "Que buenos colores!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 5, 4, "Que linda foto!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 5, 5, "buenisima", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 6, 1, "Muy linda", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 6, 2, "Que diosa", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 6, 3, "Que lindo todo", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 6, 4, "Donde estas?", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 7, 5, "Mandale un beso!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 7, 1, "Muy lindas!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 7, 2, "Feliz cumple!!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 7, 3, "que amorrr", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 8, 4, "Buenaaaa", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 8, 5, "facha", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 8, 1, "buena foto!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 8, 2, "que mal pie de post", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 9, 3, "Te extraño!!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 9, 4, "donde estas?", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 9, 5, "muy lindo!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 9, 1, "volve amigaaa", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 10, 2, "foton", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 10, 3, "Que linda playa!", DEFAULT, DEFAULT, DEFAULT),
(DEFAULT, 10, 4, "DIOSAA", DEFAULT, DEFAULT, DEFAULT),
